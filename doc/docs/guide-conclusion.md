...
This particular application is trivial, but the techniques generalize to much more complex systems. For example, see [Replidraw](https://replidraw2.vercel.app) our realtime collaborative graphics editor.
