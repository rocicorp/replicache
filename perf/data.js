    ...
    Benchmark: [
      ...
      },
      {
        commit: {
          ...
          message:
            "Remove auto-select code which doesn't work well on mobile.\n\nAlso disable zoom.",
      ...
      },
      {
        commit: {
          ...
          message:
            'Whoops confused repc version and replicache-sdk-js version.',
      ...
      },
      {
        commit: {
          ...
          message:
            "Revert change to sample app to use indexes. They aren't working yet.",
      ...
      },
      {
        commit: {
          ...
          message:
            'Revert "Revert change to sample app to use indexes. They aren\'t working yet."\n\nThis reverts commit b4cdf6a640409940af8e0229ff33b853a8556309.',
      ...
      },
      {
        commit: {
          ...
          message:
            'Move the computation of the random strings outside the perf loop (#160)\n\ncrypto.getRandomValues is not super fast.',
      ...
      },
      {
        commit: {
          ...
          message:
            'Remove out.cjs and main field in package.json (#164)\n\nCloses #151',
      ...
      },
      {
        commit: {
          ...
          message:
            'Make ScanKey exclusive optional (#167)\n\nand default to false.\r\n\r\nFixes #155',
      ...
      },
      {
        commit: {
          ...
          message:
            'Add perf test that writes a single byte in a write transaction.\n\nTowards #146',
      ...
      },
      {
        commit: {
          ...
          message:
            'Update font URL. The CSS we are caching changed its target. Not sure what correct way to do this is.',
      ...
      },
      {
        commit: {
          ...
          message:
            'Attempted fix for https://github.com/rocicorp/replicache-sdk-js/issues/172 (#176)',
      ...
      },
      {
        commit: {
          ...
          message:
            'Allow mutator function to be called with 0 arguments (#217)',
      ...
      },
      {
        commit: {
          ...
          message:
            'Info instead of error for repeated reauth failures\n\nAlso, reduce the AMX_REAUTH_TRIES to 8.\n\nFollow up to #211',
      ...
      },
      {
        commit: {
          ...
          message:
            "Give up on service worker for awhile.\n\nIt's just making everything harder :(",
      ...
      },
      {
        commit: {
          ...
          message:
            'Bump ini from 1.3.5 to 1.3.8 in /sample/next\n\nBumps [ini](https://github.com/isaacs/ini) from 1.3.5 to 1.3.8.\n- [Release notes](https://github.com/isaacs/ini/releases)\n- [Commits](https://github.com/isaacs/ini/compare/v1.3.5...v1.3.8)\n\nSigned-off-by: dependabot[bot] <support@github.com>',
      ...
      },
      {
        commit: {
          ...
          message:
            'Use Promise.resolve instead of queueMicrotask\n\nSome old iOS (?) Safari is missing it',
      ...
      },
      {
        commit: {
          ...
          message:
            'Get rid of create-react-app gunk (#256)\n\nUse esbuild and light-server instead',
      ...
      },
      {
        commit: {
          ...
          message:
            'Use an enum for RPC instead of strings (#249)\n\nStrings are slow for JS <-> Rust',
      ...
      },
      {
        commit: {
          ...
          message:
            "Make Replicache a named export (#320)\n\nBreaking change!\r\n\r\nNow you have to import using:\r\n\r\n```\r\nimport {Replicache} from 'replicache';\r\n```",
      ...
      },
      {
        commit: {
          ...
          message:
            'Introduce logLevel to ReplicacheOptions (#347)\n\nFixes #331',
      ...
      },
      {
        commit: {
          ...
          message:
            'Feat: Add onOnlineChange callback (#418)\n\nFixes #401\r\n\r\nCo-authored-by: Aaron Boodman <aaron@aaronboodman.com>',
      ...
      },
      {
        commit: {
          ...
          message:
            'Split replicache.ts into smaller files\n\nIt was getting too large to maintain',
      ...
      },
      {
        commit: {
          ...
          message:
            'Update license to allow up to 500 commercial clients and to restrict\ncompeting uses.',
