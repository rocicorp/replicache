...
export const addEvent = rep.register('addEvent', async (tx: WriteTransaction, event: Event) => {
  await tx.put(eventKey(event), event);
});

export const updateEvent = rep.register('updateEvent', async (tx: WriteTransaction, update: EventUpdate) => {
...
export const deleteEvent = rep.register('deleteEvent', async (tx: WriteTransaction, id: EventIdentity) => {
