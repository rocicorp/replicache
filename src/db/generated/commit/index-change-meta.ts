...
static getRootAsIndexChangeMeta(bb:flatbuffers.ByteBuffer, obj?:IndexChangeMeta):IndexChangeMeta {
  return (obj || new IndexChangeMeta()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsIndexChangeMeta(bb:flatbuffers.ByteBuffer, obj?:IndexChangeMeta):IndexChangeMeta {
...
static createIndexChangeMeta(builder:flatbuffers.Builder, lastMutationId:flatbuffers.Long):flatbuffers.Offset {
