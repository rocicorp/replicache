...
static getRootAsIndexDefinition(bb:flatbuffers.ByteBuffer, obj?:IndexDefinition):IndexDefinition {
  return (obj || new IndexDefinition()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsIndexDefinition(bb:flatbuffers.ByteBuffer, obj?:IndexDefinition):IndexDefinition {
...
jsonPointer(optionalEncoding:flatbuffers.Encoding):string|Uint8Array|null
...
static addKeyPrefix(builder:flatbuffers.Builder, keyPrefixOffset:flatbuffers.Offset) {
  builder.addFieldOffset(1, keyPrefixOffset, 0);
}

static createKeyPrefixVector(builder:flatbuffers.Builder, data:number[]|Uint8Array):flatbuffers.Offset {
...
static addJsonPointer(builder:flatbuffers.Builder, jsonPointerOffset:flatbuffers.Offset) {
...
static createIndexDefinition(builder:flatbuffers.Builder, nameOffset:flatbuffers.Offset, keyPrefixOffset:flatbuffers.Offset, jsonPointerOffset:flatbuffers.Offset):flatbuffers.Offset {
