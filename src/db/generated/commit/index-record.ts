...
static getRootAsIndexRecord(bb:flatbuffers.ByteBuffer, obj?:IndexRecord):IndexRecord {
  return (obj || new IndexRecord()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsIndexRecord(bb:flatbuffers.ByteBuffer, obj?:IndexRecord):IndexRecord {
...
static addValueHash(builder:flatbuffers.Builder, valueHashOffset:flatbuffers.Offset) {
...
static createIndexRecord(builder:flatbuffers.Builder, definitionOffset:flatbuffers.Offset, valueHashOffset:flatbuffers.Offset):flatbuffers.Offset {
