...
static getRootAsSnapshotMeta(bb:flatbuffers.ByteBuffer, obj?:SnapshotMeta):SnapshotMeta {
  return (obj || new SnapshotMeta()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSnapshotMeta(bb:flatbuffers.ByteBuffer, obj?:SnapshotMeta):SnapshotMeta {
...
static addLastMutationId(builder:flatbuffers.Builder, lastMutationId:flatbuffers.Long) {
  builder.addFieldInt64(0, lastMutationId, builder.createLong(0, 0));
}

static addCookieJson(builder:flatbuffers.Builder, cookieJsonOffset:flatbuffers.Offset) {
  builder.addFieldOffset(1, cookieJsonOffset, 0);
}

static createCookieJsonVector(builder:flatbuffers.Builder, data:number[]|Uint8Array):flatbuffers.Offset {
...
static createSnapshotMeta(builder:flatbuffers.Builder, lastMutationId:flatbuffers.Long, cookieJsonOffset:flatbuffers.Offset):flatbuffers.Offset {
