...
static getRootAsLeafEntry(bb:flatbuffers.ByteBuffer, obj?:LeafEntry):LeafEntry {
  return (obj || new LeafEntry()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsLeafEntry(bb:flatbuffers.ByteBuffer, obj?:LeafEntry):LeafEntry {
...
static createLeafEntry(builder:flatbuffers.Builder, keyOffset:flatbuffers.Offset, valOffset:flatbuffers.Offset):flatbuffers.Offset {
