...
export class Replicache<MD extends MutatorDefs = {}> {
  ...
  private _endHearbeats: (() => void) | undefined = undefined;
  ...
  private _schedulePersist(): void {
    clearTimeout(this._schedulePersistID);

    this._schedulePersistID = window.setTimeout(() => {
      void this._persist();
    }, PERSIST_TIMEOUT);
  }
